...
cp ~/.local/share/system42/themes/tokyo-night/alacritty.toml ~/.config/alacritty/theme.toml
cp ~/.local/share/system42/configs/alacritty/fonts/CaskaydiaMono.toml ~/.config/alacritty/font.toml
cp ~/.local/share/system42/configs/alacritty/font-size.toml ~/.config/alacritty/font-size.toml
...
source ~/.local/share/system42/install/desktop/set-alacritty-default.sh
